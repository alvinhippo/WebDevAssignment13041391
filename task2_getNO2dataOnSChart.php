...
/*
 * Get the values from xmlhttp Request
 */
$stName = $_GET["stName"];
$time =$_GET["time"];
$year = $_GET["year"];
...
/*
 * Starts converting XML data elements into JSON from xpath
 */
$xmlFile = simplexml_load_file("resources/xml/" . $stName . "_no2.xml");
$array = $xmlFile->xpath("//reading[@time = '$time' and contains(@date, '$year')]");
